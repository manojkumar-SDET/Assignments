...
test.describe('Group 1 Tests', async () => {
    ...
    test('Group 1- Test 2',{tag:'@regression'}, async ({ page }) => {
        console.log("Group 1 - Test 2: Executing");
    });

        test('Group 1- Test 3',{tag:'@sanity'}, async ({ page }) => {
...
test.describe('Group 2 Tests', async () => {
    ...
    test('Group 2- Test 2',{tag:['@sanity','@regression']}, async ({ page }) => {
        console.log("Group 2 - Test 2: Executing");
    });

        test('Group 2- Test 3',{tag:'@sanity'}, async ({ page }) => {
